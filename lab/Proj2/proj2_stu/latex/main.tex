...
\begin{document}
{\centering \textbf{CV1 : project \#2 } (total 8 points)

\par}{\centering \textbf{Restoration and Inpainting} \par}
{\centering Due October 28th (Tue), 2025, 11:59pm
...
\begin{figure}[ht!]
    ...
    \begin{subfigure}[]{0.333\linewidth}
        \centering
        \includegraphics[width=\linewidth]{latex/fig/room_ori.png}
        \includegraphics[width=\linewidth]{latex/fig/room_ori.png}
    ...
    \begin{subfigure}[]{0.333\linewidth}
        \centering
        \includegraphics[width=\linewidth]{latex/fig/mask_big.png}
        \includegraphics[width=\linewidth]{latex/fig/mask_small.png}
        \caption{Mask Image}
    \end{subfigure}%
    \hfill%
    \begin{subfigure}[]{0.333\linewidth}
        \centering
        \includegraphics[width=\linewidth]{latex/fig/imposed_room_big.png}
        \includegraphics[width=\linewidth]{latex/fig/imposed_room_small.png}
...
\end{figure}
 ...
 \begin{figure}[ht!]
    ...
    \begin{subfigure}[]{0.333\linewidth}
        \centering
        \includegraphics[width=\linewidth]{latex/fig/gate_ori.png}
        \caption{gate}
    \end{subfigure}%
    \hfill%
    \begin{subfigure}[]{0.333\linewidth}
        \centering
        \includegraphics[width=\linewidth]{latex/fig/library_ori.png}
        \caption{library}
    \end{subfigure}%
    \hfill%
    \begin{subfigure}[]{0.333\linewidth}
